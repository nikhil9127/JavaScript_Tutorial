...
// var iAmSharma = true;
// console.log(iAmSharma);



/**typeof operator*/
// console.log(typeof(iAmSharma));
...
/** Challenge or Practice of Data types  */
// console.log(10 +"20");                      1020  
// console.log(9-"5");                          4 bug
// console.log("java" + "script");             javascript
// console.log(" " + " ");
// console.log(" " + 0);                        0
// console.log("nikhil" - "sharma");           NaN
...
//or second way define NaN .....

// var myPhoneNuber = 8512012572;
// var myName = "Nikhil"

// console.log(isNaN(myPhoneNuber));
// console.log(isNaN(myName));

// if(isNaN(myName)){
//     console.log("please enter a vaild Phone Number ");
// }




/**Challenge or Practice  of NaN*/
 ...
 * Expressions is  complete package of operand and operator is called expressions
 * For example 5 is operand and + is operator And 20 is also operand
*/
// console.log(5+20);
 ...
 * An assignment oprators assigns to its left operand 
 * based on the value of its right operand .
 * The simple assignment oprator is equal (=)
 */
// var x = 5;
// var y = 5;
// console.log(x==y);
//in other way check the value like :
// console.log("is both the x and y are equal or not " + x==y); //its wrong way to check the value in this case we are join the string or value thats why get false .
...
/**Arithmetic oprator 
 * An arithmetic oprator takes numerical valuse 
 * (either literals or variable )as thier operands and 
 * retrurns a single numerical value .
 */
...
// console.log("Reminder Oprator "+81%8);
...
// console.log(myName + " ghanshyam");
// console.log(myName + " ghanshyam  sharma");
...
// var myName = "Binary brew";
// console.log(myName);

// myName = "Nikhil sharma";
// console.log(myName);

// let myName = "Binary brew";
// console.log(myName);
...
// or properties from objects, into distinct variables.
  ...
  // const myBioData = ['Nikhil', 'sharma', 26];
...
// const message = "my name is Nikhil";
// console.log(message);
...
// var myFriends = ['Nikhil','ramesh','arjun','vishal'];
...
// var myFriendNames = ["Nikhil","bahadur","sharma","sharmabrew","sharma"];

// console.log(myFriendNames.indexOf("sharma", 3));
...
// console.log(myFriendNames.lastIndexOf("sharma",3));
...
// var myFriendNames = ["Nikhil","bahadur","sharma","sharmabrew"];

// console.log(myFriendNames.includes("sharma"));
...
// // 👉 // 🤩 SUBSCRIBE TO Binary brew YOUTUBE CHANNEL 🤩
//  👉 // 🤩  https://www.youtube.com/@binarybrew01
...
// let myName = "Nikhil sharma";
// let myChannelName = 'Nikhil sharma';

// // let ytName = new String("Binary brew");
// let ytName = 'Binary brew';
...
// const myBioData =  'I am the Binary brew';
...
// const myBioData =  'I am the Binary brew';
// let sData = myBioData.search("brew");
// console.log(sData);
...
// let myBioData = `I am Nikhil bahadur sharma Nikhil`;

// let repalceData = myBioData.replace('Nikhil','Nikhil');
...
// Writing Nikhil (with upper-case) will not work
...
// if (confirm("Want to Visit BinaryBrew?")) {
//   location.href = "https://www.youtube.com/binarybrew"; // redirect the browser to another URL
// }
